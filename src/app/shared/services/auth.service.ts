...
export class AuthService {
  ...
  constructor(appConfigService: AppConfigService, router: Router) {
    const settings = {
      ...
      redirect_uri: appConfigService.config.frontend.baseUrl + "signin-callback",
      silent_redirect_uri: appConfigService.config.frontend.baseUrl + "silent-renew.html",
      post_logout_redirect_uri: appConfigService.config.frontend.baseUrl,
      response_type: 'code',
      scope: "openid profile captivlink-ui",
    };
